$(function(){
    ...
    /* sistema de pesquisa pagina venda */
    ...
    /* funcoes da pagina veiculo individual - slide */
    ...
    /* menu contato index e veiculo  */

    var directory = '/Front-end-completo/projeto_05/'
    ...
    /* menu responsivo do website */

    $('.mobile').click(function(){
        $(this).find('ul').slideToggle();
    })

    /* navegacao depoimento half2 pagina index */
